...
?>
    ...
    <div class="global-container">
      <div class="card profile-form">
        <div class="card-body">
          <h1 class="card-title text-center fs-4">Account</h1>
          <div class="card-text">
            <form action="../../process/user/changePasswordProcess.php?id_user=<?php echo $data['id_user']?>" method="POST" style="margin-top: 40px">
